...
public class DirectionalAsteridFactory extends AsteroidFactory{
    ...
    /**
     * Generates a single asteroid at a seni-random position, constrained by the direction, along at a set radius from the player.
     * 
    ...
    /**
     * Generates a shower of multiple asteroids at semi-random positions, constrained by direction, in a set radius from the player.
     *
     ...
     *
     * @param direction a float in the <code>[0,0.5)</code> range that contrains the available angle. Here 0 represents straight infront and 0.5 is the whole 360 degrees.
     */
