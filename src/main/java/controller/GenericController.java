...
/**
 * Abstract controller for implementing input handling. Provides a common
...
abstract class GenericController extends InputAdapter {
    ...
    protected final GameStateModel gameStateModel;
    protected final SpaceGame game;
    ...
    public GenericController(Screen view, GameStateModel model, SpaceGame game) {
    ...
    /**
     * Template for handling key release event. Default returns false to indicate
     * that input wasn't
     * handled. Child classes can override this to implement keyboard controls.
     *
     * @param keycode The LibGDX keycode of the pressed key.
    ...
    /**
     * Checks if left click actions are currently locked. Left click is locked when
     * right click is
    ...
    /**
     * Checks if right click actions are currently locked. Left click is locked when
     * right click is
     * being handled to prevent simultaneous actions.
     *
    ...
    /**
     * Locks left click actions. Used to prevent left click handling when right
     * click is active.
     *
    ...
    /**
     * Locks right click actions. Used to prevent left click handling when right
     * click is active.
     *
    ...
    /**
     * Template for handling left click events. Implemented by child classes to
     * define specific left
     * click behaviour.
     *
    ...
    /**
     * Template for handling right click events. Implemented by child classes to
     * define specific
    ...
    /**
     * Template for handling middle click events. Implemented by child classes to
     * define specific
    ...
    /**
     * Template for handling left click drag events. Called when mouse is dragged
     * while left button
     * is held.
     *
    ...
    /**
     * Template for handling right click drag events. Called when mouse is dragged
     * while right
     * button is held.
     *
     * @param screenX The current x-coordinate in screen coordinates.
    ...
    /**
     * Template for handling left click release events. Called when left mouse
     * button is released.
     *
     * @return true if the input was handled, false otherwise.
     */
    ...
    /**
     * Template for handling right click release events. Called when right mouse
     * button is
     * released.
     *
     * @return true if the input was handled, false otherwise.
    ...
    /**
     * Template for handling vertical scroll input. Typically used for zoom or
     * scroll operations.
     *
     * @param amountY The amount of vertical scroll (negative = up, positive =
     *                down).
     */
