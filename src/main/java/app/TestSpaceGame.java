...
public class TestSpaceGame extends Game implements SpaceGame {
    ...
    private final int METERS = 12; // screen will be meters x meters (we use meters as Game coordinates, NOT pixel
    ...
    public void setSpaceScreen() {
        if (this.spaceScreen == null) {
            ...
            this.spaceGameModel.setScreenBoundsProvider(spaceScreen);
        }
