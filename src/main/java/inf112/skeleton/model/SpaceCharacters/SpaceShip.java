...
//  private List<Gun> gunList;
    ...
    public SpaceShip(String name, String description, CharacterType characterType, float x, float y,
            int maxHealthPoints, float angle, float radius) {
        this(name, description, characterType, x, y, maxHealthPoints, maxHealthPoints, angle,
                radius);
    }

    public SpaceShip(String name, String description, CharacterType characterType, float x, float y,
            int maxHitPoints, int hitPoints, float angle, float radius) {
