...
public abstract class SpaceBody implements SpaceThing, Rotatable, ViewableSpaceBody, ControllableSpaceBody {
  private String name;
  ...
  public SpaceBody(String name, String description, CharacterType characterType,
                   Vector2 position, Vector2 velocity, float mass, float angle, float rotationSpeed, float radius) {
   ...
   * @param radius        The radius of the SpaceBody (in meters).
   * @implNote This constructor calls the full constructor with a default mass and rotation speed of 0.
   */
  public SpaceBody(String name, String description, CharacterType characterType, float x, float y, float angle, float radius) {
    this(name, description, characterType, new Vector2(x, y), new Vector2(0, 0), 0, angle, 0, radius);
  }

  /**
   * Creates a default SpaceBody object with all positional, physical, and rotational values set to zero.
   *
   * @param name          The name of the SpaceBody.
   * @param description   A brief description of the SpaceBody.
   * @param characterType The CharacterType representing the type of SpaceBody.
   * @implNote This constructor initializes the SpaceBody at (0,0) with zero mass, angle, velocity, and radius.
   */
  public SpaceBody(String name, String description, CharacterType characterType) {
