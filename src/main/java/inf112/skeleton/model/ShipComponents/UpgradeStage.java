...
public enum UpgradeStage {
    ...
    //TODO: Consider if there should be a unique UpgradeStage-esque enum for each type of upgrade, in case different upgrade types have a different number of total stages 
    ...
    // Being able to display the number of upgrade stages available could be a nice detail for the view
