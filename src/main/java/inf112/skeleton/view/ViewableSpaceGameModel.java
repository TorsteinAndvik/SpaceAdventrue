...
public interface ViewableSpaceGameModel {
   ...
   * TODO: There should be another "viewable" interface for model-objects, such that the view doesn't get access to the model
   * 
  ...
  Asteroid getAsteroid();
    ...
    /**
   * Returns the enemy ship of the MVP //TODO: Remove this once a proper model is in place
   * 
