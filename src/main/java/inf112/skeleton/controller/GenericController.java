...
abstract class GenericController extends InputAdapter {
  ...
  /**
   * Template for handling right click events. Implemented by child classes to define specific right
   * click behaviour.
   *
   * @param screenX The x-coordinate of the click in screen coordinates.
   * @param screenY The y-coordinate of the click in screen coordinates.
  ...
  /**
   * Template for handling left click drag events. Called when mouse is dragged while left button is
   * held.
   *
  ...
  /**
   * Template for handling right click drag events. Called when mouse is dragged while right button
   * is held.
   *
   * @param screenX The current x-coordinate in screen coordinates.
   * @param screenY The current y-coordinate in screen coordinates.
  ...
  /**
   * Template for handling right click release events. Called when right mouse button is released.
   *
   * @return true if the input was handled, false otherwise.
   */
